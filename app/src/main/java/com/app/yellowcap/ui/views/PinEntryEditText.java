...
public class PinEntryEditText extends EditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int colorFocused = isInEditMode() ? Color.GRAY : ContextCompat.getColor(context, R.color.job_posted_background);
        mColors[1] = colorFocused;

        int colorUnfocused = isInEditMode() ? Color.GRAY : ContextCompat.getColor(context, R.color.job_posted_background);
